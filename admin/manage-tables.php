            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select AdminName,tblrestables.id as tid,tblrestables.tableNumber,tblrestables.creationDate,tblrestables.status from tblrestables
...
?>
                  ...
                  <tr>
                   ...
                   <td><?php echo $result['creationDate']?></td>
                    ...
                    <td> 
                        <form action="update-table-status.php" method="post">
                            ...
                            <select name="status">
                                ...
                                <option value="occupied" <?php echo ($result['status'] == 'occupied') ? 'selected' : ''; ?>>Occupied</option>
                            </select>

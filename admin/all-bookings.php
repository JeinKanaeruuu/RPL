                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <?php
                                        $query = mysqli_query($con,"SELECT *, DATE_FORMAT(bookingDate, '%d-%m-%Y') AS formattedDate FROM tblbookings");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $result['formattedDate']?> / <?php echo $result['bookingTime']?></td>
                                            <td><?php echo $result['postingDate']?></td>
                                            <td>
                                                <a href="booking-details.php?bid=<?php echo $result['id'];?>" title="View Details" class="btn btn-primary btn-xm"> View Details</a>
                                                <a href="delete-booking.php?id=<?php echo $result['id'];?>" title="Delete Booking" class="btn btn-danger btn-xm"> Delete</a>
                                            </td>
                                        </tr>
                                        <?php $cnt++;} ?>
                                    </tbody>
